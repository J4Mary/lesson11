...
--
-- Name: s_film_genre; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.s_film_genre (
    film_id integer DEFAULT 0 NOT NULL,
    genre_id integer DEFAULT 0 NOT NULL
);


ALTER TABLE public.s_film_genre OWNER TO postgres;
...
--
-- Data for Name: s_film_genre; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.s_film_genre (film_id, genre_id) FROM stdin;
2	2
2	7
3	2
3	4
